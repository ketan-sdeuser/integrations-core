...
from datadog_checks.dev.utils import ON_WINDOWS, running_on_windows_ci, write_file, read_file
...
class TestAuthTokenDCOS:
    def test_token_auth(self):
        ...
        http = RequestsWrapper(instance, init_config)
        with mock.patch('requests.post', side_effect=login) as post, mock.patch(
            'requests.get', side_effect=auth
        ) as get:
